// Service-Based Sector KY question bank — 9 sub-sectors x 9 questions.
...
// "Note on Abbreviations" blocks (rendered as hover tooltips).
export const SERVICE_DOMAINS = [
  {
    slug: 'technology-saas',
    name: 'Technology & SaaS / Digital Products',
    questions: [
      {
        text: 'How does your team release new features and software updates?',
        category: 'operations-execution',
        glossary: [{ abbreviation: 'CI/CD', fullForm: 'Continuous Integration / Continuous Deployment' }],
        options: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'APM', fullForm: 'Application Performance Monitoring' }],
        options: [
      ...
      },
      {
        ...
        category: 'sales-market-growth',
        glossary: [{ abbreviation: 'PDF', fullForm: 'Portable Document Format' }],
        options: [
      ...
      },
      {
        ...
        category: 'digital-innovation',
        glossary: [{ abbreviation: 'CDP', fullForm: 'Customer Data Platform' }],
        options: [
    ...
    questions: [
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'KYC', fullForm: 'Know Your Customer' }],
        options: [
      ...
      },
      {
        ...
        category: 'digital-innovation',
        glossary: [{ abbreviation: 'AI', fullForm: 'Artificial Intelligence' }],
        options: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'RegTech', fullForm: 'Regulatory Technology' }],
        options: [
      ...
      },
      {
        ...
        category: 'digital-innovation',
        glossary: [{ abbreviation: 'API', fullForm: 'Application Programming Interface' }],
        options: [
  ...
  },
  {
    ...
    name: 'Supply Chain, Logistics & Distribution',
    questions: [
      {
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'SMS', fullForm: 'Short Message Service' }],
        options: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'RMA', fullForm: 'Return Merchandise Authorization' }],
        options: [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'PSA', fullForm: 'Professional Services Automation' }],
        options: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'SOW', fullForm: 'Statement of Work' }],
        options: [
      ...
      },
      {
        ...
        category: 'financial-performance',
        glossary: [{ abbreviation: 'WIP', fullForm: 'Work-In-Progress' }],
        options: [
    ...
    questions: [
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'DOM', fullForm: 'Distributed Order Management' }],
        options: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'BOPIS', fullForm: 'Buy Online, Pick Up In Store' }],
        options: [
      ...
      },
      {
        ...
        glossary: [
          { abbreviation: 'PDF', fullForm: 'Portable Document Format' },
          { abbreviation: 'Planogram', fullForm: 'Visual diagram defining the precise placement of retail products on store shelves' },
        ],
        options: [
      ...
      },
      {
        ...
        category: 'sales-market-growth',
        glossary: [{ abbreviation: 'A/B Testing', fullForm: 'Showing two page/flow versions to different visitors to see which generates more orders' }],
        options: [
  ...
  {
    slug: 'franchise-multi-unit',
    name: 'Franchise & Multi-Unit Chains',
    questions: [
      {
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'JIT', fullForm: 'Just-In-Time' }],
        options: [
      ...
      },
      {
        ...
        glossary: [{ abbreviation: 'FSSAI', fullForm: 'Food Safety and Standards Authority of India' }],
        options: [
      ...
      },
      {
        ...
        category: 'people-organization',
        glossary: [{ abbreviation: 'LMS', fullForm: 'Learning Management System' }],
        options: [
    ...
    questions: [
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'POS', fullForm: 'Point of Sale' }],
        options: [
      ...
      },
      {
        ...
        category: 'sales-market-growth',
        glossary: [{ abbreviation: 'CRM', fullForm: 'Customer Relationship Management' }],
        options: [
  ...
  {
    slug: 'fitness-gym-wellness-operations',
    name: 'Fitness, Gym & Wellness Operations',
    questions: [
      {
      ...
      },
      {
        ...
        category: 'sales-market-growth',
        glossary: [{ abbreviation: 'PT', fullForm: 'Personal Training' }],
        options: [
      ...
      },
      {
        ...
        category: 'sales-market-growth',
        glossary: [{ abbreviation: 'BMI', fullForm: 'Body Mass Index' }],
        options: [
  ...
  },
  {
    ...
    name: 'Healthcare & Life Sciences Operations',
    questions: [
      {
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'RBAC', fullForm: 'Role-Based Access Control' }],
        options: [
      ...
      },
      {
        ...
        category: 'digital-innovation',
        glossary: [{ abbreviation: 'RPM', fullForm: 'Remote Patient Monitoring' }],
        options: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'LIS', fullForm: 'Laboratory Information System' }],
        options: [
      ...
      },
      {
        ...
        category: 'operations-execution',
        glossary: [{ abbreviation: 'NABH', fullForm: 'National Accreditation Board for Hospitals & Healthcare Providers' }],
        options: [
